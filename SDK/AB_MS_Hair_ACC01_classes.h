...
public:
	...
	unsigned char                                      UnknownData_JWH9[0x8];                                     // 0x0CA8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_MS_Hair_ACC01.AB_MS_Hair_ACC01_C"));
		return ptr;
	}
