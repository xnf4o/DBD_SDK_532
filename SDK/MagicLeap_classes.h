...
public:
	...
	unsigned char                                      UnknownData_1FOG[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EJ5E[0x50];                                    // 0x0188(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BA3Z[0x8];                                     // 0x0210(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2SKI[0x6];                                     // 0x022A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5L32[0x3];                                     // 0x0239(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FGGT[0x3];                                     // 0x0241(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DO61[0x5];                                     // 0x024B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T243[0x7];                                     // 0x0281(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1BM0[0xC];                                     // 0x0294(0x000C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_9BRM[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4QQX[0x68];                                    // 0x00B8(0x0068) MISSED OFFSET (PADDING)
