...
public:
	...
	unsigned char                                      UnknownData_85EJ[0x8];                                     // 0x1DF8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_LS_Hair_ACC01.AB_LS_Hair_ACC01_C"));
		return ptr;
	}
