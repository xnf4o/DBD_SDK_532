...
// AnimBlueprintGeneratedClass AB_DF_Hair_ACC01.AB_DF_Hair_ACC01_C
// 0x04F0 (FullSize[0x0770] - InheritedSize[0x0280])
class UAB_DF_Hair_ACC01_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_DF_Hair_ACC01.AB_DF_Hair_ACC01_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_DF_Hair_ACC01(int EntryPoint);
};
