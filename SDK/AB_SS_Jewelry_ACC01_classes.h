...
public:
	...
	unsigned char                                      UnknownData_6JOW[0x8];                                     // 0x1998(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_SS_Jewelry_ACC01.AB_SS_Jewelry_ACC01_C"));
		return ptr;
	}
