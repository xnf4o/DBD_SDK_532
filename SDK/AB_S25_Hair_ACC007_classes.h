...
// AnimBlueprintGeneratedClass AB_S25_Hair_ACC007.AB_S25_Hair_ACC007_C
// 0x27F8 (FullSize[0x2A78] - InheritedSize[0x0280])
class UAB_S25_Hair_ACC007_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	unsigned char                                      UnknownData_RAD7[0x8];                                     // 0x1538(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_S25_Hair_ACC007.AB_S25_Hair_ACC007_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_S25_Hair_ACC007(int EntryPoint);
};
