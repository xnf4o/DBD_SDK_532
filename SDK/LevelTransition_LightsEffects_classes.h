...
public:
	...
	unsigned char                                      UnknownData_AA8P[0x3];                                     // 0x0245(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass LevelTransition_LightsEffects.LevelTransition_LightsEffects_C"));
		return ptr;
	}
