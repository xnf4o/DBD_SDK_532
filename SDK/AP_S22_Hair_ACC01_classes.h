...
public:
	...
	unsigned char                                      UnknownData_S2EV[0x8];                                     // 0x1538(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AP_S22_Hair_ACC01.AP_S22_Hair_ACC01_C"));
		return ptr;
	}
