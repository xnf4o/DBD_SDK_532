...
{
public:
	unsigned char                                      UnknownData_K8A9[0x20];                                    // 0x0100(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalAnalyticsComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_2N6V[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTagStateBool                               _isInTantrum;                                              // 0x03E0(0x0030) (Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_L1TC[0x20];                                    // 0x0410(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawAttack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_LB0M[0x18];                                    // 0x0168(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawAttackOpenSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawAttackHittingSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawAttackSuccessSubstate"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_6DSK[0x10];                                    // 0x0120(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawAttackMissSubstate"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_HG46[0x28];                                    // 0x0158(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawAttackObstructSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawHitEventAddon"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_GZKP[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NOQU[0xC8];                                    // 0x00D8(0x00C8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JNFK[0x8];                                     // 0x01D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawPowerComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_KEWJ[0x90];                                    // 0x0740(0x0090) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalChainsawRevInteraction"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CannibalPowerPresentationItemProgressComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_6F47[0x10];                                    // 0x02A8(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.CarburetorTuningGuideAddon"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_IJAO[0x10];                                    // 0x02A8(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.IridescentLeatherAddon"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheCannibal.ShopLubricantAddon"));
		return ptr;
	}
