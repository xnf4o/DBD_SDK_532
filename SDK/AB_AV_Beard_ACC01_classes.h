...
// AnimBlueprintGeneratedClass AB_AV_Beard_ACC01.AB_AV_Beard_ACC01_C
// 0x04F0 (FullSize[0x0770] - InheritedSize[0x0280])
class UAB_AV_Beard_ACC01_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_2;                             // 0x03D8(0x0030)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_AV_Beard_ACC01.AB_AV_Beard_ACC01_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_AV_Beard_ACC01(int EntryPoint);
};
