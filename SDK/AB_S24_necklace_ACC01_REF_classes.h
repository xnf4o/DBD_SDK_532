...
public:
	...
	unsigned char                                      UnknownData_T550[0x8];                                     // 0x10D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_S24_necklace_ACC01_REF.AB_S24_necklace_ACC01_REF_C"));
		return ptr;
	}
