...
// AnimBlueprintGeneratedClass AB_S26_Necklace_ACC02.AB_S26_Necklace_ACC02_C
// 0x1678 (FullSize[0x18F8] - InheritedSize[0x0280])
class UAB_S26_Necklace_ACC02_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	unsigned char                                      UnknownData_QIJS[0x8];                                     // 0x0C78(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_S26_Necklace_ACC02.AB_S26_Necklace_ACC02_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_S26_Necklace_ACC02(int EntryPoint);
};
