...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SystemUtilities.ArrayExt"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SystemUtilities.BoolExt"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SystemUtilities.DateTimeProvider"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_BYQJ[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SystemUtilities.TimeProviderMock"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_E07F[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SystemUtilities.DateTimerUpdater"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SystemUtilities.DebugUtilities"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SystemUtilities.PlatformUtilities"));
		return ptr;
	}
