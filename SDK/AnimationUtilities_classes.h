...
{
public:
	unsigned char                                      UnknownData_NAUJ[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.SleepingAnimInstance"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.AnimCollection"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_WF0Q[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.AnimEffectBlackBoard"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.AnimEffectHandler"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.AnimInstanceExt"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_HGHH[0x3];                                     // 0x0235(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AM05[0x30];                                    // 0x0240(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.DetectionFanComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_WX76[0x54];                                    // 0x02AC(0x0054) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.ArmDetectionFanComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_QM8A[0xB0];                                    // 0x00B8(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0T6U[0x2];                                     // 0x0176(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9JJI[0x4];                                     // 0x017C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3C8P[0x8];                                     // 0x0188(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8X2L[0x34];                                    // 0x019C(0x0034) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.BaseGroundDetectorComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_XTEQ[0x10];                                    // 0x00D0(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.BoneSocketLocalVelocityEvaluator"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_VNAU[0x4];                                     // 0x01F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.FootGroundDetectorComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_365M[0x4];                                     // 0x01DC(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.FromBoneGroundDetectorComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.AnimInstanceLeader"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_3YM1[0x48];                                    // 0x00B8(0x0048) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.MoveComponentToComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.ResetControlPitchAnimNotify"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NCQO[0x8];                                     // 0x0278(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.SlaveAnimInstance"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AnimationUtilities.SleepingSkinnedMeshRegisterer"));
		return ptr;
	}
