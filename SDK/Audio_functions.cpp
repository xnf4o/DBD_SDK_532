...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Audio.Audio_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Audio.Audio_C.ExecuteUbergraph_Audio"));
