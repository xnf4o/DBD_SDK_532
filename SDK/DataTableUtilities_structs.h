...
struct FDBDTunableRowHandle
{
	...
	unsigned char                                      UnknownData_56M3[0xC];                                     // 0x001C(0x000C) MISSED OFFSET (PADDING)
...
struct FDBDTableRowBaseWithId : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_385A[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FDataTableProxy
{
	...
	unsigned char                                      UnknownData_RBPW[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
