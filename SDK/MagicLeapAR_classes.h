...
public:
	...
	unsigned char                                      UnknownData_U1N5[0x3];                                     // 0x0119(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6BFL[0x6];                                     // 0x013A(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_G1VY[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
