...
struct FStatModifier
{
	...
	unsigned char                                      UnknownData_3QVD[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BZ3H[0x1F];                                    // 0x0011(0x001F) MISSED OFFSET (PADDING)
...
struct FBaseStat
{
	unsigned char                                      UnknownData_ALS6[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2AG2[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (PADDING)
...
struct FNonTunableStat : public FBaseStat
{
	...
	unsigned char                                      UnknownData_P0BJ[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FStatProperty : public FBaseStat
{
	...
	unsigned char                                      UnknownData_JANU[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
