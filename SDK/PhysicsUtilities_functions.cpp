...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PhysicsUtilities.DynamicCapsuleResizerComponent.SetShrinkingEnabled"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PhysicsUtilities.DynamicCapsuleResizerComponent.OnRep_IsShrinkingAlwaysEnabled"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PhysicsUtilities.DynamicCapsuleResizerComponent.OnHit"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PhysicsUtilities.PrimitiveCollection.Remove"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PhysicsUtilities.PrimitiveCollection.Add"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PhysicsUtilities.PrimitivesRegistererComponent.SetPrimitives"));
