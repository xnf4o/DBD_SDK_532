...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SystemUtilities.BoolExt.ToString"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SystemUtilities.PlatformUtilities.GetPlatform"));
