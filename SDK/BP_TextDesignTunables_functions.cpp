...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_TextDesignTunables.BP_TextDesignTunables_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_TextDesignTunables.BP_TextDesignTunables_C.ReceiveTick"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_TextDesignTunables.BP_TextDesignTunables_C.ExecuteUbergraph_BP_TextDesignTunables"));
