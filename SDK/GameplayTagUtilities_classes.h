...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GameplayTagUtilities.DBDGameplayTagUtilities"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_X4XE[0x70];                                    // 0x00B8(0x0070) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GameplayTagUtilities.GameplayTagContainerComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GameplayTagUtilities.ObjectStateProvider"));
		return ptr;
	}
