...
public:
	...
	unsigned char                                      UnknownData_DIPK[0xA4];                                    // 0x034C(0x00A4) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_N2ZV[0x18];                                    // 0x0588(0x0018) MISSED OFFSET (PADDING)
