...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AB_Menu_Nea.AB_Menu_Nea_C.Override_nea_1"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AB_Menu_Nea.AB_Menu_Nea_C.Override_Dynamic"));
