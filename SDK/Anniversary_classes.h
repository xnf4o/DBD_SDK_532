...
{
public:
	unsigned char                                      UnknownData_Y3NK[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_QZSE[0x28];                                    // 0x06E0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WZI2[0xB];                                     // 0x0715(0x000B) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Anniversary.CrownPickupInteraction"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Anniversary.CrownPillarInteractable"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Anniversary.CrownPillarOutlineUpdateStrategy"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ST5M[0x7];                                     // 0x0211(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTagStateBool                               _isCrownEventActive;                                       // 0x0218(0x0030) (Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_MVY7[0x28];                                    // 0x0248(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Anniversary.CrownPlayerComponent"));
		return ptr;
	}
