...
struct FButtonSequenceData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_9Q7V[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_40ND[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1O6Q[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
