...
{
	unsigned char                                      UnknownData_MUO2[0x68];                                    // 0x0000(0x0068) MISSED OFFSET (PADDING)
...
struct FActionOnFriend
{
	...
	unsigned char                                      UnknownData_WLSF[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFriendStatusUIData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_RIM7[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMatchConfigOptionUIData
{
	...
	unsigned char                                      UnknownData_HPDE[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QLQ8[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
