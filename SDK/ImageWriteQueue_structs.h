...
struct FImageWriteOptions
{
	...
	unsigned char                                      UnknownData_2FIQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VREJ[0x4];                                     // 0x0001(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_EZGL[0x42];                                    // 0x001E(0x0042) MISSED OFFSET (PADDING)
