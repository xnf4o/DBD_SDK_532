...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StartScreen.StartScreen_C.K2Node_MatineeController_1_FadedOutEvent"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StartScreen.StartScreen_C.K2Node_MatineeController_1_Finished"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StartScreen.StartScreen_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StartScreen.StartScreen_C.BeginDestroyTravelSequence"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StartScreen.StartScreen_C.ExecuteUbergraph_StartScreen"));
