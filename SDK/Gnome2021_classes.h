...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Gnome2021.Gnome"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_5RSN[0x18];                                    // 0x00D8(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Gnome2021.GnomeEventComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_17DS[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_2MIL[0x10];                                    // 0x06E0(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Gnome2021.GnomeInteraction"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_SZT0[0x27];                                    // 0x00B9(0x0027) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Gnome2021.GnomePlayerComponent"));
		return ptr;
	}
