...
public:
	...
	unsigned char                                      UnknownData_4XCU[0x2];                                     // 0x0A2A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_Menu_Slasher03.AB_Menu_Slasher03_C"));
		return ptr;
	}
