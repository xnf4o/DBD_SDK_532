...
// AnimBlueprintGeneratedClass AB_S27_Hair01.AB_S27_Hair01_C
// 0x27F8 (FullSize[0x2A78] - InheritedSize[0x0280])
class UAB_S27_Hair01_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	unsigned char                                      UnknownData_BDDA[0x8];                                     // 0x1538(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_S27_Hair01.AB_S27_Hair01_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_S27_Hair01(int EntryPoint);
};
