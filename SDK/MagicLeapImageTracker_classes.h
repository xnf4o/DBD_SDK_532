...
public:
	...
	unsigned char                                      UnknownData_0NNM[0x2];                                     // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HFIJ[0x10];                                    // 0x0280(0x0010) MISSED OFFSET (PADDING)
