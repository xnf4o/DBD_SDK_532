...
public:
	...
	unsigned char                                      UnknownData_VE6B[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class BuildPatchServices.BuildPatchManifest"));
		return ptr;
	}
