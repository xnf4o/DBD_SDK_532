...
public:
	...
	unsigned char                                      UnknownData_C7HO[0x3];                                     // 0x0235(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QU4X[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0NLD[0x20];                                    // 0x0260(0x0020) MISSED OFFSET (PADDING)
