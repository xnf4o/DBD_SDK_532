...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher04.BP_Menu_Slasher04_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher04.BP_Menu_Slasher04_C.ExecuteUbergraph_BP_Menu_Slasher04"));
