...
struct FInputChord
{
	...
	unsigned char                                      UnknownData_ZKSM[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomizedToolMenuEntry
{
	...
	unsigned char                                      UnknownData_ZF2I[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	Slate_ECustomizedToolMenuVisibility                Visibility;                                                // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_44BZ[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FCustomizedToolMenu
{
	...
	unsigned char                                      UnknownData_RS1Y[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T1XQ[0xE0];                                    // 0x0110(0x00E0) MISSED OFFSET (PADDING)
