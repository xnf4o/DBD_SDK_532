...
struct FActivationDefinition
{
	...
	unsigned char                                      UnknownData_ZFFL[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_AGN9[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
