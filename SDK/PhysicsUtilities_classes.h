...
public:
	...
	unsigned char                                      UnknownData_CP5M[0x14];                                    // 0x00C0(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G4AJ[0x6];                                     // 0x00EA(0x0006) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class PhysicsUtilities.DynamicCapsuleResizerComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class PhysicsUtilities.PrimitiveCollection"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class PhysicsUtilities.PrimitivesRegistererComponent"));
		return ptr;
	}
