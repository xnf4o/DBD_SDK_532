...
enum class SocialParty_EPartyError : uint8_t
{
	...
	EPartyError__InvitationValidationError_ListenServerCrossplayIncompatibility = 52,
	EPartyError__RemovePlayerFromPartyFail = 53,
	EPartyError__JoinFail_PlayerAlreadyInParty = 54,
	EPartyError__UnknownError      = 55,
	EPartyError__EPartyError_MAX   = 56,
...
{
	unsigned char                                      UnknownData_WTC9[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BDL3[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O1OY[0x5];                                     // 0x0093(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_2QB9[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2G9U[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KGBM[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DD1H[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FF3L[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GQA0[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WM77[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	bool                                               _isUsingDedicatedServer;                                   // 0x0145(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_IJ4T[0x2];                                     // 0x0146(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
