...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Anniversary.CrownPillarInteractable.Local_OnIntroCompleted"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Anniversary.CrownPillarInteractable.IsLocallyObservedPlayerEquippedWithAnniversaryOffering"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Anniversary.CrownPillarInteractable.Cosmetic_OnStoppedInteracting"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Anniversary.CrownPillarInteractable.Cosmetic_OnStartedInteracting"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Anniversary.CrownPillarInteractable.Cosmetic_OnInteractionCompleted"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Anniversary.CrownPillarInteractable.Cosmetic_OnInteractionCancelled"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Anniversary.CrownPlayerComponent.OnRep_hasInteractedWithCrownPillarThisGame"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Anniversary.CrownPlayerComponent.Cosmetic_OnInteractedWithCrownPillar"));
