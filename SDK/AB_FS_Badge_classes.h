...
public:
	...
	unsigned char                                      UnknownData_ABUP[0x8];                                     // 0x10D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_FS_Badge.AB_FS_Badge_C"));
		return ptr;
	}
