...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaOutput.Validate"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaOutput.CreateMediaCapture"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaCapture.UpdateTextureRenderTarget2D"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaCapture.StopCapture"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaCapture.SetMediaOutput"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaCapture.GetState"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaCapture.GetDesiredSize"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaCapture.GetDesiredPixelFormat"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaCapture.CaptureTextureRenderTarget2D"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MediaIOCore.MediaCapture.CaptureActiveSceneViewport"));
