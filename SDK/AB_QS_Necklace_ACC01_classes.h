...
// AnimBlueprintGeneratedClass AB_QS_Necklace_ACC01.AB_QS_Necklace_ACC01_C
// 0x1678 (FullSize[0x18F8] - InheritedSize[0x0280])
class UAB_QS_Necklace_ACC01_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	unsigned char                                      UnknownData_8PC1[0x8];                                     // 0x0C78(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_QS_Necklace_ACC01.AB_QS_Necklace_ACC01_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_QS_Necklace_ACC01(int EntryPoint);
};
