...
public:
	...
	unsigned char                                      UnknownData_B7UM[0x8];                                     // 0x0C78(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_QF_Necklace_ACC01.AB_QF_Necklace_ACC01_C"));
		return ptr;
	}
