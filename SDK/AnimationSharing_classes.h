...
public:
	...
	unsigned char                                      UnknownData_HHIK[0x7];                                     // 0x0281(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_TUIW[0xB];                                     // 0x0285(0x000B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LIJJ[0xB];                                     // 0x0285(0x000B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S53Q[0x70];                                    // 0x0040(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QW4U[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SGY3[0x10];                                    // 0x0100(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_20WG[0x20];                                    // 0x0120(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_I700[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (PADDING)
