...
public:
	...
	unsigned char                                      UnknownData_FGCS[0x3];                                     // 0x0655(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7TFO[0x7];                                     // 0x0661(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Menu_BaseSlasher.BP_Menu_BaseSlasher_C"));
		return ptr;
	}
