...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class OnlinePresence.MirrorsConfig"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_E2IS[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class OnlinePresence.OnlinePresenceExternalCommands"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class OnlinePresence.SteamConfig"));
		return ptr;
	}
