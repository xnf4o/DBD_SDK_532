...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher01.BP_Menu_Slasher01_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher01.BP_Menu_Slasher01_C.ExecuteUbergraph_BP_Menu_Slasher01"));
