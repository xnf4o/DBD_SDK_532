...
public:
	...
	unsigned char                                      UnknownData_WP51[0x8];                                     // 0x3968(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_QF_Hair_ACC01.AB_QF_Hair_ACC01_C"));
		return ptr;
	}
