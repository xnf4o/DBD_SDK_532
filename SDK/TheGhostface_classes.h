...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheGhostface.GhostfaceCrouchAttack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_CWQJ[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGhostKillerAnalytics                       _ghostKillerAnalytics;                                     // 0x00F0(0x00E0) (Net, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_FK7W[0x28];                                    // 0x01D0(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheGhostface.GhostKillerAnalyticsComponent"));
		return ptr;
	}
