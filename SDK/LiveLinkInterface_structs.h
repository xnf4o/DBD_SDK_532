...
struct FLiveLinkSourceBufferManagementSettings
{
	...
	unsigned char                                      UnknownData_V1Y5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1SYG[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YFG8[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EUKJ[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R7PR[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HBF0[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2Y08[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W49Y[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GP6H[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MA77[0x160];                                   // 0x0000(0x0160) MISSED OFFSET (PADDING)
...
struct FSubjectMetadata
{
	...
	unsigned char                                      UnknownData_AGTH[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FLiveLinkBaseFrameData
{
	...
	unsigned char                                      UnknownData_5IJT[0x20];                                    // 0x0080(0x0020) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_0BD7[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_52SL[0xB];                                     // 0x00E5(0x000B) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_PUUW[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkLightStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_6D3W[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_BZBW[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_6MQG[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkSubjectPreset
{
	...
	unsigned char                                      UnknownData_LAKM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EYDM[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkSubjectRepresentation
{
	...
	unsigned char                                      UnknownData_F1R8[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkInterpolationSettings
{
	...
	unsigned char                                      UnknownData_HPN1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkTransformBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_0FJM[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
