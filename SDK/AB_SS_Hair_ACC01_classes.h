...
public:
	...
	unsigned char                                      UnknownData_TY1U[0x8];                                     // 0x3D68(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_SS_Hair_ACC01.AB_SS_Hair_ACC01_C"));
		return ptr;
	}
