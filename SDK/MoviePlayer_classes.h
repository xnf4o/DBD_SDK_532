...
public:
	...
	unsigned char                                      UnknownData_CFO3[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class MoviePlayer.MoviePlayerSettings"));
		return ptr;
	}
