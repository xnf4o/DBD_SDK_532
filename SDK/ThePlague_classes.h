...
public:
	...
	unsigned char                                      UnknownData_DWQ0[0xA4];                                    // 0x00BC(0x00A4) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePlague.PlagueSurvivorAnalyticsComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_5H3R[0x58];                                    // 0x0508(0x0058) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePlague.SicknessSurvivorSubAnimInstance"));
		return ptr;
	}
