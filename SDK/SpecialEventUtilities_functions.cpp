...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.RespawnableInteractable.OnUnhidden"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.RespawnableInteractable.OnRep_IsHidden"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.RespawnableInteractable.OnHidden"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.RespawnableInteractable.IsHidden"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.RespawningEventComponent.DBD_ForceRespawnSpecialEventObject"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.RespawningEventComponent.Authority_OnIsInteractingWithAnyRespawnableInteractableChanged"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.InteractionRespawnableTrigger.Authority_OnNewRespawnableSubscribed"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.InteractionRespawnableTrigger.Authority_OnInteractionEnded"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.RespawnablePositioner.Authority_OnIsInteractingChangedEvent"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SpecialEventUtilities.RespawnablePositioner.Authority_GetRespawnables"));
