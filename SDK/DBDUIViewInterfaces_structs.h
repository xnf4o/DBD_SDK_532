...
struct FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_FK2U[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QE40[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FAddonViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_T95K[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
...
struct FCharacterTooltipViewData
{
	...
	unsigned char                                      UnknownData_IEA0[0x1];                                     // 0x0057(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_EM1G[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3O36[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PY8U[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_637A[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
struct FCurrencyTooltipViewData
{
	...
	unsigned char                                      UnknownData_CYLV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_VG28[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_STZS[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	DBDSharedTypes_ECurrencyType                       CurrencyType;                                              // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RMXQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0VS1[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FCustomizationTooltipViewData
{
	...
	unsigned char                                      UnknownData_37HY[0x2];                                     // 0x0096(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A6IP[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_1AM6[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UTexture2D*                                  IconTexture;                                               // 0x0008(0x0008) (Edit, BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_90H3[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7SP9[0x7];                                     // 0x00E1(0x0007) MISSED OFFSET (PADDING)
...
struct FPerkViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_5IU6[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FItemViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_0IO3[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MV8K[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TO09[0x6];                                     // 0x008A(0x0006) MISSED OFFSET (PADDING)
...
struct FStatusEffectAlertViewData
{
	...
	unsigned char                                      UnknownData_Y74E[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScoreAlertViewData
{
	...
	unsigned char                                      UnknownData_EGVL[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHudObjectivesViewData
{
	...
	unsigned char                                      UnknownData_C4ES[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHudObjectiveViewData
{
	DBDSharedTypes_EPlayerTeam                         playerTeam;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               isHatchOpen;                                               // 0x0001(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_8DNX[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                nbGeneratorsLeft;                                          // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FStatusEffectViewData
{
	...
	unsigned char                                      UnknownData_1ZBJ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      IconTexture[0x30];                                         // 0x000C(0x0030) UNKNOWN PROPERTY: SoftObjectProperty
	DBDSharedTypes_EStatusEffectType                   StatusEffectType;                                          // 0x0040(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CCNE[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q9PG[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FInteractionProgressViewData
{
	...
	unsigned char                                      UnknownData_K74S[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       ID;                                                        // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_MKS9[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3BUJ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W7TZ[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FMatchResultViewData
{
	...
	unsigned char                                      UnknownData_NNAR[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOfferingViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_7FJS[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_656I[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_78VP[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FRewardWrapperViewData
{
	...
	unsigned char                                      UnknownData_DMJ1[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FCharacterRewardViewData                    CharacterRewardViewData;                                   // 0x0008(0x0098) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FCurrencyRewardViewData                     CurrencyRewardViewData;                                    // 0x00A0(0x0048) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FCustomizationRewardViewData                CustomizationRewardViewData;                               // 0x00E8(0x00E8) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FProgressionRewardViewData                  ProgressionRewardViewData;                                 // 0x01D0(0x000C) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_H15C[0x4];                                     // 0x01DC(0x0004) MISSED OFFSET (PADDING)
...
struct FOnboardingTutorialViewData
{
	...
	unsigned char                                      UnknownData_13DL[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5NEN[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOnboardingStepViewData
{
	...
	unsigned char                                      UnknownData_B63R[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGhostStatusData
{
	...
	unsigned char                                      UnknownData_LEI7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNightmareStatusData
{
	...
	unsigned char                                      UnknownData_8FVL[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPigStatusData
{
	...
	unsigned char                                      UnknownData_GT19[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlagueStatusData
{
	...
	unsigned char                                      UnknownData_BC7X[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTricksterStatusData
{
	...
	unsigned char                                      UnknownData_HXA9[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FK25StatusData
{
	...
	unsigned char                                      UnknownData_HI3N[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FPlayerStatusViewData
{
	...
	unsigned char                                      UnknownData_L0ER[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H848[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TM3P[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZW2E[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPowerViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_5100[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TF3M[0x2];                                     // 0x0086(0x0002) MISSED OFFSET (PADDING)
...
struct FScreenIndicatorViewData
{
	...
	unsigned char                                      UnknownData_0NYB[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OZAO[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FSkillCheckViewData
{
	...
	unsigned char                                      UnknownData_7AXZ[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FStartSequenceViewData
{
	...
	unsigned char                                      UnknownData_BGOY[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8WOD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
