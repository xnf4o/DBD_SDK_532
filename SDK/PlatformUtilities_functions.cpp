...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlatformUtilities.PlatformSupportSubsystem.DBD_StadiaShowStreamDebug"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlatformUtilities.PlatformSupportSubsystem.DBD_StadiaRoleSelectPoll"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlatformUtilities.PlatformSupportSubsystem.DBD_StadiaCharacterSelectPoll"));
