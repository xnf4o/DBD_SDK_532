...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_RHQO[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_885W[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6KGJ[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
struct FOnlineProxyStoreOffer
{
	...
	unsigned char                                      UnknownData_DZVW[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IHYJ[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ADU8[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductInfo2
{
	...
	unsigned char                                      UnknownData_5S60[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest2
{
	...
	unsigned char                                      UnknownData_EFXM[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
