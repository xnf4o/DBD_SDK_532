...
{
	unsigned char                                      UnknownData_J5DG[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLevelSequenceObject
{
	...
	unsigned char                                      UnknownData_T9I8[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequenceSnapshotSettings
{
	...
	unsigned char                                      UnknownData_KC36[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequencePlayerSnapshot
{
	...
	unsigned char                                      UnknownData_DLSE[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AK8T[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HNKM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FA6B[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
