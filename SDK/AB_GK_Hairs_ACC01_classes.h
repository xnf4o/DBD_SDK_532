...
public:
	...
	unsigned char                                      UnknownData_TCYL[0x8];                                     // 0x10D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_GK_Hairs_ACC01.AB_GK_Hairs_ACC01_C"));
		return ptr;
	}
