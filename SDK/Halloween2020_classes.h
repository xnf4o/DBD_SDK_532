...
public:
	...
	unsigned char                                      UnknownData_XQD0[0x40];                                    // 0x02B0(0x0040) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Halloween2020.BlightedSerumAddon"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_3ZPA[0x14];                                    // 0x05BC(0x0014) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Halloween2020.BlightedSerumCollisionInteraction"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_EFP8[0x8];                                     // 0x05B8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Halloween2020.BlightedSerumCooldownInteraction"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_D6BI[0x58];                                    // 0x05F8(0x0058) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Halloween2020.BlightedSerumDashInteraction"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_6Q3C[0x8];                                     // 0x0318(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Halloween2020.ToxinPlantInteractable"));
		return ptr;
	}
