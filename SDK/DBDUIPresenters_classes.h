...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.UIComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_7N4W[0x3F];                                    // 0x00B9(0x003F) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.ContextObserver"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_S32Q[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BSTM[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.Presenter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_5FR8[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.HudPresenter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_8WL8[0x38];                                    // 0x0110(0x0038) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.ExamplePresenter"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_FGUK[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.FocusHandler"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.SubPresenter"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.GameManualSubPresenter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_IS98[0x48];                                    // 0x0110(0x0048) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.HudObjectivesPresenter"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.HudRootContainer"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_V6HY[0x18];                                    // 0x0100(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.OnboardingMenuPresenter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_MT5F[0x50];                                    // 0x00C8(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.OnboardingTutorialSubPresenter"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_VPXW[0x20];                                    // 0x00B8(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.PawnObserver"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.PresenterGroup"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.PresenterGroupHandler"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_LJM8[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.RootContainer"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_JU3M[0x30];                                    // 0x0110(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.SkillCheckPresenter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_BJOQ[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.TemplatePresenter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_RR0R[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.TestPresenter"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIPresenters.UIConsoleCommands"));
		return ptr;
	}
