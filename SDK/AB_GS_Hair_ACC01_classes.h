...
public:
	...
	unsigned char                                      UnknownData_ZTZ4[0x8];                                     // 0x41C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_GS_Hair_ACC01.AB_GS_Hair_ACC01_C"));
		return ptr;
	}
