...
struct FMediaPlayerOptions
{
	...
	unsigned char                                      UnknownData_N7XE[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3M8P[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
