...
public:
	...
	unsigned char                                      UnknownData_C2UC[0x8];                                     // 0x10D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_K23_Hair_ACC01_REF.AB_K23_Hair_ACC01_REF_C"));
		return ptr;
	}
