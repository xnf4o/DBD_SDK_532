...
struct FClaimableInboxMessageData
{
	...
	unsigned char                                      UnknownData_G9DW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInboxMessageData
{
	...
	unsigned char                                      UnknownData_KJ1G[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClaimableInboxMessage
{
	...
	unsigned char                                      UnknownData_WX0P[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
