...
{
	unsigned char                                      UnknownData_XTTQ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2GTW[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
struct FLightUpdate
{
	...
	unsigned char                                      UnknownData_IXE7[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
