...
{
	unsigned char                                      UnknownData_WZJP[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
struct FImpactInfo
{
	...
	unsigned char                                      UnknownData_VFKC[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7BPJ[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
