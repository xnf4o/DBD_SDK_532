...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function GameplayTagUtilities.DBDGameplayTagUtilities.GetScoreModifierName"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function GameplayTagUtilities.DBDGameplayTagUtilities.GameplayTagExists"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function GameplayTagUtilities.GameplayTagContainerComponent.Remove"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function GameplayTagUtilities.GameplayTagContainerComponent.Add"));
