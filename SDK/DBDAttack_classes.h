...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAttack.PounceAttack"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_HQK2[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAttack.PounceAttackOpenSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAttack.PounceAttackHittingSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAttack.PounceAttackSuccessSubstate"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_BHCJ[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAttack.PounceAttackMissSubstate"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_AWF0[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAttack.PounceAttackObstructSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAttack.PounceAttackOpenSubstateCosmetic"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAttack.SlashAttack"));
		return ptr;
	}
