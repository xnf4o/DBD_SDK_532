...
public:
	...
	unsigned char                                      UnknownData_X3XI[0x3];                                     // 0x0211(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PHSZ[0x3];                                     // 0x0215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_119K[0x3];                                     // 0x0671(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2OIN[0x4];                                     // 0x067C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CMZM[0x20];                                    // 0x0690(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I2XP[0x30];                                    // 0x06C0(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.SynthComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_9WFU[0x80];                                    // 0x0030(0x0080) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.AudioGenerator"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.AudioMixerBlueprintLibrary"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_OVY6[0x78];                                    // 0x0048(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.SubmixEffectDynamicsProcessorPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_8MQ2[0x38];                                    // 0x0048(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSubmixEffectSubmixEQSettings               Settings;                                                  // 0x0080(0x0010) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.SubmixEffectSubmixEQPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_SIFK[0x5C];                                    // 0x0048(0x005C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSubmixEffectReverbSettings                 Settings;                                                  // 0x00A4(0x0034) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.SubmixEffectReverbPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_98AF[0x60];                                    // 0x0048(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.SubmixEffectReverbFastPreset"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_BT82[0x18];                                    // 0x0378(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.SynthSound"));
		return ptr;
	}
