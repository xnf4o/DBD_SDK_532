...
struct FAnimationMontageDescriptor
{
	...
	unsigned char                                      UnknownData_WQTZ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMontagePlaybackDefinition
{
	...
	unsigned char                                      UnknownData_5H4U[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XWGK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FMontageStopDefinition
{
	...
	unsigned char                                      UnknownData_NL1P[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FTaggedAnimCollection
{
	...
	unsigned char                                      UnknownData_BPJM[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
