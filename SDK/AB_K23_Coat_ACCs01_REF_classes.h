...
public:
	...
	unsigned char                                      UnknownData_J7I7[0x8];                                     // 0x2258(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_K23_Coat_ACCs01_REF.AB_K23_Coat_ACCs01_REF_C"));
		return ptr;
	}
