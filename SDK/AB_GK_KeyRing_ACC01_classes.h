...
class UAB_GK_KeyRing_ACC01_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	struct FAnimNode_ConvertLocalToComponentSpace      AnimGraphNode_LocalToComponentSpace_2;                     // 0x0770(0x0020)
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_3;                             // 0x0790(0x0030)
	...
	unsigned char                                      UnknownData_6PDW[0x8];                                     // 0x0818(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimNode_ConvertLocalToComponentSpace      AnimGraphNode_LocalToComponentSpace;                       // 0x0CA0(0x0020)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_GK_KeyRing_ACC01.AB_GK_KeyRing_ACC01_C"));
		return ptr;
	}
