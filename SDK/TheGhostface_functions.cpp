...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TheGhostface.GhostKillerAnalyticsComponent.Local_OnStalkModeChanged"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TheGhostface.GhostKillerAnalyticsComponent.Local_OnLeanStateChanged"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TheGhostface.GhostKillerAnalyticsComponent.Local_OnIsStealthChanged"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TheGhostface.GhostKillerAnalyticsComponent.Authority_OnStalkChargePercentChanged"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TheGhostface.GhostKillerAnalyticsComponent.Authority_OnPreAttackSuccess"));
