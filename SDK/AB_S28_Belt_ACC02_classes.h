...
// AnimBlueprintGeneratedClass AB_S28_Belt_ACC02.AB_S28_Belt_ACC02_C
// 0x0DB8 (FullSize[0x1038] - InheritedSize[0x0280])
class UAB_S28_Belt_ACC02_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	unsigned char                                      UnknownData_NZCY[0x8];                                     // 0x0818(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_S28_Belt_ACC02.AB_S28_Belt_ACC02_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_S28_Belt_ACC02(int EntryPoint);
};
