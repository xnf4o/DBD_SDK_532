...
{
public:
	unsigned char                                      UnknownData_SG8E[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDInput.ControlModeManager"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_KVMJ[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RAYN[0x38];                                    // 0x0078(0x0038) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDInput.DBDInputManager"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDInput.InteractiveWidgetInterface"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_GMGJ[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDInput.MultipleGamepadsControlModeInfo"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_XVOB[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDInput.SwitchDockStateManager"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDInput.UIInputUtilities"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_BSLV[0x38];                                    // 0x0038(0x0038) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDInput.VirtualKeyboardManager"));
		return ptr;
	}
