...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UnitTestUtilities.TestInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UnitTestUtilities.TestActor"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UnitTestUtilities.TestActorComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_5EON[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UnitTestUtilities.TestActorComponentImplementingTestInterface"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_DIKB[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UnitTestUtilities.TestActorImplementingTestInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UnitTestUtilities.TestMovableActor"));
		return ptr;
	}
