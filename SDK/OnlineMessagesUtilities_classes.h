...
public:
	...
	unsigned char                                      UnknownData_AOKS[0x20];                                    // 0x00C8(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class OnlineMessagesUtilities.OnlineMessagesContainerComponent"));
		return ptr;
	}
