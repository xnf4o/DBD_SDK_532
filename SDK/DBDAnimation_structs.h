...
struct FFootBoneData
{
	...
	unsigned char                                      UnknownData_Y3BZ[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_63MZ[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
