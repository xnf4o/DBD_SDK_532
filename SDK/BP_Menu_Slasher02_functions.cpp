...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher02.BP_Menu_Slasher02_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher02.BP_Menu_Slasher02_C.ExecuteUbergraph_BP_Menu_Slasher02"));
