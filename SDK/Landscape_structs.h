...
struct FLandscapeProxyMaterialOverride
{
	...
	unsigned char                                      UnknownData_JDHM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPerPlatformInt                             LODIndex;                                                  // 0x0000(0x0004) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_35SN[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UMaterialInterface*                          Material;                                                  // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FWeightmapLayerAllocationInfo
{
	...
	unsigned char                                      UnknownData_UN8F[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FGrassVariety
{
	...
	unsigned char                                      UnknownData_T3DE[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_97MH[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7R1U[0x5];                                     // 0x0043(0x0005) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineConnection
{
	...
	unsigned char                                      UnknownData_EGFP[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FGrassInput
{
	...
	unsigned char                                      UnknownData_LRPD[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BKMP[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
struct FLayerBlendInput
{
	...
	unsigned char                                      UnknownData_HEWU[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            LayerInput;                                                // 0x0010(0x0010) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_632Z[0xC];                                     // 0x0020(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            HeightInput;                                               // 0x002C(0x0010) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_5KRH[0xC];                                     // 0x003C(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_11JV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLandscapeLayer
{
	...
	unsigned char                                      UnknownData_YSHO[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CRWA[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_TEAN[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLandscapeInfoLayerSettings
{
	...
	unsigned char                                      UnknownData_Y1RL[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q65O[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TPO9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J1NN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NO86[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E9O5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineMeshEntry
{
	...
	unsigned char                                      UnknownData_8Q9Q[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BMES[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NS9F[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (PADDING)
