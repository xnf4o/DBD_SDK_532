...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DynamicContent.AsyncTaskDownloadCacheImage"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_KHY3[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DynamicContent.DownloadingTextureTask"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NE4L[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B6O1[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DynamicContent.DownloadMultiTextureTask"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_7WR6[0x138];                                   // 0x0038(0x0138) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DynamicContent.DynamicContentHolder"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DynamicContent.LoadingImagesDataProvider"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_CCIE[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O64O[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DynamicContent.LoopBannerProvider"));
		return ptr;
	}
