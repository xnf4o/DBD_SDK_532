...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ApexDestruction.DestructibleActor"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_JCEP[0x7];                                     // 0x06D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F63E[0x3];                                     // 0x06E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OSZ5[0x10];                                    // 0x06F0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_12NX[0xA0];                                    // 0x0710(0x00A0) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ApexDestruction.DestructibleComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_SSQZ[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F3WO[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YSLH[0x28];                                    // 0x0098(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ApexDestruction.DestructibleFractureSettings"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_JU0C[0x8];                                     // 0x0420(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ApexDestruction.DestructibleMesh"));
		return ptr;
	}
