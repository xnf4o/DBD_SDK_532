...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ProceduralMeshComponent.KismetProceduralMeshLibrary"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_PUP5[0x8];                                     // 0x0478(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_B131[0x6];                                     // 0x0482(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GU80[0x4];                                     // 0x04CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ProceduralMeshComponent.ProceduralMeshComponent"));
		return ptr;
	}
