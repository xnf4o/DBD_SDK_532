...
struct FQosPingServerInfo
{
	...
	unsigned char                                      UnknownData_TM8M[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FQosDatacenterInfo
{
	...
	unsigned char                                      UnknownData_D64L[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatacenterQosInstance
{
	...
	unsigned char                                      UnknownData_30XM[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MJKV[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UJ6G[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FQosRegionInfo
{
	...
	unsigned char                                      UnknownData_XGV0[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
