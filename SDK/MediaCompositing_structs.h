...
struct FMovieSceneMediaPlayerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_3HQQ[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneMediaSectionParams
{
	...
	unsigned char                                      UnknownData_AAHH[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
