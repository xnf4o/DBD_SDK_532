...
public:
	...
	unsigned char                                      UnknownData_NVPS[0x8];                                     // 0x1538(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_GK_FlowerKeyBow_ACC01.AB_GK_FlowerKeyBow_ACC01_C"));
		return ptr;
	}
