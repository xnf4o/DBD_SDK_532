...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.AnalyticsDelegates"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.AnalyticsFunctionLibrary"));
		return ptr;
	}
...
// 0x38B0 (FullSize[0x38E8] - InheritedSize[0x0038])
class UAnalyticsManager : public UAbstractAnalyticsManager
{
public:
	unsigned char                                      UnknownData_J0IQ[0x38B0];                                  // 0x0038(0x38B0) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.AnalyticsManager"));
		return ptr;
	}
...
// 0x0000 (FullSize[0x38E8] - InheritedSize[0x38E8])
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.AtlantaAnalyticsManager"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.ClosetAnalytics"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.DBDAnalytics"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_GU06[0xE8];                                    // 0x00B8(0x00E8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.EmblemAnalyticsComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_1DNP[0xB8];                                    // 0x00B8(0x00B8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.InteractionAnalyticsComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.PerkAnalyticsLibrary"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.PigAnalytics"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.PulldownAnalytics"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAnalytics.SurvivorInteractionAnalytics"));
		return ptr;
	}
