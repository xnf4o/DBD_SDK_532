...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.CatalogValidationCommandlet"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.CustomizationValidationCommandlet"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.DataTableToCsvCommandlet"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.FixCustomizationAccessorySocketCommandlet"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.GenerateCurveFloatNetIdTableCommandlet"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_4ZGT[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.GenerateStoreCustomizationExclusionFileCommandlet"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.JournalsValidationCommandlet"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_0GNR[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.LoadoutExportCommandlet"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.StoryDescriptionValidationCommandlet"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class CommandletPlugin.UpdateJournalVignetteCinematicsCommandlet"));
		return ptr;
	}
