...
struct FGCReference
{
	...
	unsigned char                                      UnknownData_2U43[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FGFxWidgetBinding
{
	...
	unsigned char                                      UnknownData_UL8U[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FASDisplayInfo
{
	...
	unsigned char                                      UnknownData_HPLC[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FASValue
{
	...
	unsigned char                                      UnknownData_D3ZM[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7ZMB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     ASString;                                                  // 0x0010(0x0010) (BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_LAKC[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
