...
// AnimBlueprintGeneratedClass AB_K25_Knives_ACC01.AB_K25_Knives_ACC01_C
// 0x30B8 (FullSize[0x3338] - InheritedSize[0x0280])
class UAB_K25_Knives_ACC01_C : public UDynamicAccessoryAnimInstance
{
public:
	...
	unsigned char                                      UnknownData_KI2I[0x8];                                     // 0x1998(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_K25_Knives_ACC01.AB_K25_Knives_ACC01_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_K25_Knives_ACC01(int EntryPoint);
};
