...
struct FAIGoalWeight
{
	...
	unsigned char                                      UnknownData_XA2P[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRelevantNodeMemory
{
	...
	unsigned char                                      UnknownData_C64S[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FMindFocusObjectEntry
{
	...
	unsigned char                                      UnknownData_C6H8[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FName, float>                          CooldownMap;                                               // 0x0018(0x0050) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CVI3[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QJZ6[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FNavLinkInteractPlayerSetup
{
	...
	unsigned char                                      UnknownData_J3M0[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_4FES[0x24];                                    // 0x0000(0x0024) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KOD9[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
