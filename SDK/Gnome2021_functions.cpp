...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Gnome2021.Gnome.Cosmetic_OnStoppedInteracting"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Gnome2021.Gnome.Cosmetic_OnStartedInteracting"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Gnome2021.Gnome.Cosmetic_OnInteractionCompleted"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Gnome2021.GnomeEventComponent.Authority_OnEndGameStarted"));
