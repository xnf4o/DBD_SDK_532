...
{
	unsigned char                                      UnknownData_2G1J[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FNiagaraCompileEvent
{
	...
	unsigned char                                      UnknownData_CUTN[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
