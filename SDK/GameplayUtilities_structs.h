...
struct FAuthorityDiscernedCharacter
{
	...
	unsigned char                                      UnknownData_C6NL[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	class ACharacter*                                  _character;                                                // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_ELQS[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FHitValidatorInstigatorParams
{
	...
	unsigned char                                      UnknownData_ZGA0[0x48];                                    // 0x0008(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q0Q2[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (PADDING)
...
struct FHitValidatorTargetParams
{
	...
	unsigned char                                      UnknownData_R6AG[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FHitValidationReport
{
	...
	unsigned char                                      UnknownData_8NGC[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IRJK[0xD];                                     // 0x00A3(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C8KW[0x2];                                     // 0x00FE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
