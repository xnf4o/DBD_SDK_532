...
public:
	...
	unsigned char                                      UnknownData_W2II[0x2];                                     // 0x0226(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YP12[0xD0];                                    // 0x0270(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VNJ6[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
