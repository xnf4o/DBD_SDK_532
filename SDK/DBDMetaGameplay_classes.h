...
{
public:
	unsigned char                                      UnknownData_DM6J[0x40];                                    // 0x0108(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9EAL[0x18];                                    // 0x0150(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_KillerChaser"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_TWO5[0x20];                                    // 0x0108(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T01C[0x8];                                     // 0x0138(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_KillerDevout"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_284N[0x30];                                    // 0x0108(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_KillerGatekeeper"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_ODQY[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<class ACamperPlayer*, int>                    _remainingSurvivorHookStates;                              // 0x0118(0x0050) (Transient, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_WH7I[0x8];                                     // 0x0168(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_KillerMalicious"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_0LP1[0x60];                                    // 0x0108(0x0060) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_SurvivorBenevolent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_VBJA[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_SurvivorEvader"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_UOYB[0x88];                                    // 0x0108(0x0088) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_SurvivorLightbringer"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_AOQP[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KDQW[0x10];                                    // 0x0120(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_SurvivorUnbroken"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDMetaGameplay.DBDEmblem_KillerGatekeeperTest"));
		return ptr;
	}
