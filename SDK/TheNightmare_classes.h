...
public:
	...
	unsigned char                                      UnknownData_5D5A[0x18];                                    // 0x02C0(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.BlackBox"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.DreamInducerComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.DreamSnare"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_2DTQ[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.GeneratorDreamworldComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_0TJC[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_Q5W1[0x40];                                    // 0x06E8(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OW9N[0x8];                                     // 0x0738(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0U65[0x2];                                     // 0x0772(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QTJ8[0x8];                                     // 0x0798(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.GeneratorTeleportInteraction"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_E894[0x1F];                                    // 0x04F1(0x001F) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.InDreamSurvivorSubAnimInstance"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_XXJM[0x8];                                     // 0x05A8(0x0008) Fix Super Size


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.NightmareAnimInstance"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_N77Y[0x8];                                     // 0x05C0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.PlaceDreamPalletInteraction"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_LBB9[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.PresentationGeneratorTeleportProgressComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_F78K[0x4];                                     // 0x06D8(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_J44V[0xC];                                     // 0x06E4(0x000C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheNightmare.SetDreamSnareInteraction"));
		return ptr;
	}
