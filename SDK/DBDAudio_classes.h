...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAudio.AmbienceBoxComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAudio.AnimNotify_PostInteractionSoundEvent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAudio.AudioUtilities"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAudio.InteractionAudioComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAudio.LoadAsyncBankData"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_4FP4[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDAudio.SoundBankLoader"));
		return ptr;
	}
