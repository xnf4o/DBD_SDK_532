...
{
	unsigned char                                      UnknownData_7H5J[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FBox
{
	...
	unsigned char                                      UnknownData_ZKB1[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FBox2D
{
	...
	unsigned char                                      UnknownData_4O89[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurvePointFloat
{
	...
	unsigned char                                      UnknownData_REGU[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveFloat
{
	...
	unsigned char                                      UnknownData_WEGN[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpCurvePointVector2D
{
	...
	unsigned char                                      UnknownData_XEQF[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector2D
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3QFG[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointVector
{
	...
	unsigned char                                      UnknownData_S3MF[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HBNI[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	float                                              InVal;                                                     // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_U0J4[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W1D0[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (PADDING)
...
struct FInterpCurveQuat
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_P344[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointTwoVectors
{
	...
	unsigned char                                      UnknownData_NEN5[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveTwoVectors
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_5XF3[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointLinearColor
{
	...
	unsigned char                                      UnknownData_ZJOU[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveLinearColor
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JXCQ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FTransform
{
	...
	unsigned char                                      UnknownData_4ICT[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TTRT[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FDateTime
{
	unsigned char                                      UnknownData_4I5M[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FTimecode
{
	...
	unsigned char                                      UnknownData_Z2LO[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FTimespan
{
	unsigned char                                      UnknownData_VT1G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSoftObjectPath
{
	...
	unsigned char                                      UnknownData_KHHQ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_OT3W[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFloatRangeBound
{
	...
	unsigned char                                      UnknownData_EQEH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	TEnumAsByte<CoreUObject_ERangeBoundTypes>          Type;                                                      // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_S2AR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolyglotTextData
{
	...
	unsigned char                                      UnknownData_KEIP[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N8US[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationEvent
{
	...
	unsigned char                                      UnknownData_0XZA[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationExecutionEntry
{
	...
	unsigned char                                      UnknownData_PJYL[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
