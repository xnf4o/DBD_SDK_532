...
public:
	...
	unsigned char                                      UnknownData_G613[0x8];                                     // 0x0508(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PDQ4[0x8];                                     // 0x3ED8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_S24_Hair_ACC01.AB_S24_Hair_ACC01_C"));
		return ptr;
	}
