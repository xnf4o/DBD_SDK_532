...
struct FMagicLeapPlaneResult
{
	...
	unsigned char                                      UnknownData_C10M[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapPlanesQuery
{
	...
	unsigned char                                      UnknownData_9FGA[0xE];                                     // 0x0052(0x000E) MISSED OFFSET (PADDING)
