...
{
public:
	unsigned char                                      UnknownData_O5QO[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UITween.UITween"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_WP9U[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UITween.UITweenMaterialScalarProperties"));
		return ptr;
	}
...
public:
	class UMaterialInstanceDynamic*                    MaterialInstance;                                          // 0x0030(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Y1WS[0x40];                                    // 0x0038(0x0040) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UITween.UITweenMaterialVectorProperties"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_UTJ7[0x98];                                    // 0x0050(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UITween.UITweenInstance"));
		return ptr;
	}
