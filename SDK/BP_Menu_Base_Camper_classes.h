...
public:
	...
	unsigned char                                      UnknownData_FGR3[0x3];                                     // 0x065D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Menu_Base_Camper.BP_Menu_Base_Camper_C"));
		return ptr;
	}
