...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OnlinePresence.OnlinePresenceExternalCommands.DBD_MirrorsWalletWithdraw"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OnlinePresence.OnlinePresenceExternalCommands.DBD_MirrorsWalletGetCurrency"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OnlinePresence.OnlinePresenceExternalCommands.DBD_MirrorsSaveTestValue"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OnlinePresence.OnlinePresenceExternalCommands.DBD_MirrorsGetValue"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OnlinePresence.OnlinePresenceExternalCommands.DBD_IsDlcInstalled"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OnlinePresence.OnlinePresenceExternalCommands.DBD_GrantPromoItems"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OnlinePresence.OnlinePresenceExternalCommands.DBD_GenerateTestItems"));
