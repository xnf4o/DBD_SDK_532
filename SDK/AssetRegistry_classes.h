...
{
public:
	unsigned char                                      UnknownData_3QQC[0x750];                                   // 0x0030(0x0750) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AssetRegistry.AssetRegistryImpl"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AssetRegistry.AssetRegistryHelpers"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AssetRegistry.AssetRegistry"));
		return ptr;
	}
