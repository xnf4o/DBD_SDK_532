...
{
public:
	unsigned char                                      UnknownData_C9GO[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DP3L[0x4];                                     // 0x024C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GIIS[0x4];                                     // 0x0284(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_555Y[0x8];                                     // 0x0890(0x0008) MISSED OFFSET (PADDING)
