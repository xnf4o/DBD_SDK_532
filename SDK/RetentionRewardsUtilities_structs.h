...
struct FRetentionReward
{
	...
	unsigned char                                      UnknownData_S8SI[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRetentionCalendar
{
	...
	unsigned char                                      UnknownData_HKBG[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCampaignStatus
{
	...
	unsigned char                                      UnknownData_ZDKN[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
