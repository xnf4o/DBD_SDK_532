...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePig.Addon_ThePig_JigsawSketch"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_ZOWT[0x10];                                    // 0x0360(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePig.PigAmbushAttack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_43VV[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePig.PigAmbushAttackOpenSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePig.PigAmbushAttackHittingSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePig.PigAmbushAttackSuccessSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePig.PigAmbushAttackMissSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class ThePig.PigAmbushAttackObstructSubstate"));
		return ptr;
	}
