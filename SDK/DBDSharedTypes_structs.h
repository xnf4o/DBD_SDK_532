...
enum class DBDSharedTypes_EHudComponent : uint8_t
{
	...
	EHudComponent__EHudComponent_MAX = 17,
...
struct FFriendData
{
	unsigned char                                      UnknownData_DRZS[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FHelpCategoryData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_XRBE[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRarityMaterialData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_BBSX[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
