...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_MSE9[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_V9OT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_YM1T[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_W9F6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q78J[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C1W7[0x18];                                    // 0x00D0(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PURX[0x10];                                    // 0x06E0(0x0010) MISSED OFFSET (PADDING)
...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_PK15[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
