...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ActionSpeedProficiency.ActionSpeedProficiency_C.FetchInteractingPlayers"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ActionSpeedProficiency.ActionSpeedProficiency_C.Compute Overall speed including multiple interactors"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ActionSpeedProficiency.ActionSpeedProficiency_C.ShouldAndCanShowMultipleActorsSpeedProficiency"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ActionSpeedProficiency.ActionSpeedProficiency_C.GetValue"));
