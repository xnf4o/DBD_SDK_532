...
public:
	...
	unsigned char                                      UnknownData_LU0K[0x18];                                    // 0x00D8(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Anniversary2021.Anniversary2021EventComponent"));
		return ptr;
	}
