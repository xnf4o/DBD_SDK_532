...
public:
	...
	unsigned char                                      UnknownData_3DD4[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U86U[0xC0];                                    // 0x00C8(0x00C0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SharedAuthenticationUtilities.SharedAuthenticationComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_I0CA[0x38];                                    // 0x0038(0x0038) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SharedAuthenticationUtilities.SharedAuthenticationMigrateComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_2U9C[0x37];                                    // 0x0261(0x0037) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SharedAuthenticationUtilities.UMGAuthenticationProviderSelection"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_J5A7[0x18];                                    // 0x0260(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SharedAuthenticationUtilities.UMGAutheticationProviderSelection"));
		return ptr;
	}
