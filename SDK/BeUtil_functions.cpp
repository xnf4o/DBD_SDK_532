...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BeUtil.BeMaterialEditorHelper.ReloadTexture"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BeUtil.BeMaterialEditorHelper.EditMaterialConstant"));
