...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.Spawn Niagara Particles Character Dissolve"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.SpawnFootstepKillerVFX"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.SpawnFootstepVFX"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.ManageInteractiveMist"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MakeCharacter_Visible"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MakeCharacter_Invisible"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MaskFPV_Visible"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MaskFPV_Hidden"));
