...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFXUtilities.VFXUtilities.SetParticleSystemsActive"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VFXUtilities.VFXUtilities.SetParticleSystemActive"));
