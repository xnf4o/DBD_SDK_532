...
{
	unsigned char                                      UnknownData_GPN0[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAccumulator
{
	unsigned char                                      UnknownData_6CL7[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1TCF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
