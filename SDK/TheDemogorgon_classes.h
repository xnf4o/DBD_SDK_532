...
public:
	...
	unsigned char                                      UnknownData_XE6Y[0x7];                                     // 0x0279(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SIVI[0x40];                                    // 0x02B0(0x0040) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.DemogorgonHuskAnimInstance"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_JHAF[0x70];                                    // 0x0360(0x0070) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.DemogorgonPounceAttack"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.DemogorgonPounceAttackOpenSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.DemogorgonPounceAttackSuccessSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.DemogorgonPounceAttackMissSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.DemogorgonPounceAttackObstructSubstate"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_64E4[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_PEC1[0x68];                                    // 0x06E0(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BASI[0x38];                                    // 0x0758(0x0038) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.DemogorgonPounceInteraction"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.DemogorgonPowerItemProgressComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_HM9U[0x18];                                    // 0x0298(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.ElevensSodaAddon"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_7ARX[0x40];                                    // 0x04F0(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YKIR[0xD];                                     // 0x0533(0x000D) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheDemogorgon.PortalSurvivorSubAnimInstance"));
		return ptr;
	}
