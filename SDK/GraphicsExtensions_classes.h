...
{
public:
	unsigned char                                      UnknownData_STSG[0xB8];                                    // 0x0030(0x00B8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GraphicsExtensions.GMAdaptiveShadowMapAtlas"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_L002[0x68];                                    // 0x0060(0x0068) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GraphicsExtensions.GMAdaptiveShadowMapController"));
		return ptr;
	}
...
// 0x01E0 (FullSize[0x03F0] - InheritedSize[0x0210])
...
public:
	...
	unsigned char                                      UnknownData_7LT7[0x4];                                     // 0x02C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ETZ5[0x6];                                     // 0x036A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M9VU[0x13];                                    // 0x037D(0x0013) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GraphicsExtensions.GMAdaptiveShadowMapControllerComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_9AQY[0x2B8];                                   // 0x0040(0x02B8) Fix Super Size


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GraphicsExtensions.GMAdaptiveShadowMapSource"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_SFW4[0x3];                                     // 0x0211(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BDMH[0x8];                                     // 0x0228(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GraphicsExtensions.GMAdaptiveShadowMapSourceComponent"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_BBW0[0x1];                                     // 0x0233(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6RI7[0x3];                                     // 0x023D(0x0003) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GraphicsExtensions.GMAdaptiveShadowMapSourceComponentSpawner"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ZD7R[0x50];                                    // 0x0300(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GraphicsExtensions.GMAdaptiveShadowMapSourceDirectional"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_4P2E[0x60];                                    // 0x0300(0x0060) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class GraphicsExtensions.GMAdaptiveShadowMapSourceSpot"));
		return ptr;
	}
