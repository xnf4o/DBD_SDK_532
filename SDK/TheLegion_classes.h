...
{
public:
	unsigned char                                      UnknownData_8NQP[0x10];                                    // 0x0360(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheLegion.FrenzyAttack"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheLegion.FrenzyAttackHittingSubstate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheLegion.FrenzyAttackSuccessSubstate"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_H3IO[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheLegion.LegionKillerAnalyticsComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_UW1Y[0x58];                                    // 0x00B8(0x0058) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheLegion.LegionSurvivorAnalyticsComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TheLegion.Madgrit"));
		return ptr;
	}
