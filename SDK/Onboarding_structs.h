...
struct FOnboardingBotMatchDefinition : public FDBDTableRowBaseWithId
{
	...
	unsigned char                                      UnknownData_W1NS[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOnboardingTutorialDefinition : public FDBDTableRowBaseWithId
{
	...
	unsigned char                                      UnknownData_6O60[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSecretBotMatchNamesDefinition : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_KQQB[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
