...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Effect_Mist.BP_Effect_Mist_C.ReceiveTick"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Effect_Mist.BP_Effect_Mist_C.ExecuteUbergraph_BP_Effect_Mist"));
