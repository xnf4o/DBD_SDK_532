...
public:
	...
	unsigned char                                      UnknownData_K1O3[0x7];                                     // 0x0231(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class VFXUtilities.BaseVFX"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class VFXUtilities.VFXUtilities"));
		return ptr;
	}
