...
public:
	...
	unsigned char                                      UnknownData_ZTCL[0x7];                                     // 0x0331(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.RespawnableInteractable"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.RespawningEventComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.RespawnableTrigger"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.InteractionRespawnableTrigger"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_5OB8[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.RespawnablePositioner"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.RespawnableStrategy"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.RespawnFurthestFromPlayersStrategy"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.RespawningEventUtilities"));
		return ptr;
	}
...
public:
	class URespawningEventComponent*                   _respawningEventComponent;                                 // 0x00B8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_4NOW[0x40];                                    // 0x00C0(0x0040) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class SpecialEventUtilities.TimedRespawnableTrigger"));
		return ptr;
	}
