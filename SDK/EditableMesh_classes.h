...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMeshAdapter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_5D03[0x9C];                                    // 0x0044(0x009C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableGeometryCollectionAdapter"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_XEUE[0x390];                                   // 0x0030(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x03C0(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WLRA[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VXVN[0x148];                                   // 0x03DC(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7K5L[0x1E4];                                   // 0x052C(0x01E4) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMesh"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMeshFactory"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_3LE1[0xA4];                                    // 0x0044(0x00A4) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableStaticMeshAdapter"));
		return ptr;
	}
