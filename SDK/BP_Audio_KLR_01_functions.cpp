...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Audio_KLR_01.BP_Audio_KLR_01_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Audio_KLR_01.BP_Audio_KLR_01_C.ReceiveEndPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Audio_KLR_01.BP_Audio_KLR_01_C.ExecuteUbergraph_BP_Audio_KLR_01"));
