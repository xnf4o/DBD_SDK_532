...
{
	unsigned char                                      UnknownData_YSCM[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FName, class UTexture2DDynamic*>       _cachedTextures;                                           // 0x0010(0x0050) (Transient, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_797V[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
struct FTaskContainer
{
	...
	unsigned char                                      UnknownData_T1XP[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FLoadingImagesHintInfo
{
	...
	unsigned char                                      UnknownData_GSQU[0x6];                                     // 0x00C2(0x0006) MISSED OFFSET (PADDING)
...
struct FLoadingImages
{
	...
	unsigned char                                      UnknownData_178W[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GPY9[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6DC2[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                Priority;                                                  // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YRVW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
