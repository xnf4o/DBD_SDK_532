...
public:
	...
	unsigned char                                      UnknownData_SJUS[0x8];                                     // 0x2B18(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_S25_Hair_ACC01_REF.AB_S25_Hair_ACC01_REF_C"));
		return ptr;
	}
