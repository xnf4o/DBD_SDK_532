...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TimeManagement.FixedFrameRateCustomTimeStep"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TimeManagement.TimeManagementBlueprintLibrary"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_GZZI[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TimeManagement.TimeSynchronizationSource"));
		return ptr;
	}
