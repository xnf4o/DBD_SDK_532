...
struct FMediaCaptureOptions
{
	...
	unsigned char                                      UnknownData_04NF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IGWY[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FMediaIOMode
{
	...
	unsigned char                                      UnknownData_UALG[0x3];                                     // 0x0010(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaIOConnection
{
	...
	unsigned char                                      UnknownData_KG3U[0x3];                                     // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_6IBN[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaIOConfiguration
{
	...
	unsigned char                                      UnknownData_1C4P[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMediaIOOutputConfiguration
{
	...
	unsigned char                                      UnknownData_NJPE[0x3];                                     // 0x0044(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_57MG[0x3];                                     // 0x004C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaIOInputConfiguration
{
	...
	unsigned char                                      UnknownData_XVVN[0x3];                                     // 0x0044(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                KeyPortIdentifier;                                         // 0x0048(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
