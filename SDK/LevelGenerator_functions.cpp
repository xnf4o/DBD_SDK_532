...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function LevelGenerator.LevelGenerator_C.RemoveMist"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function LevelGenerator.LevelGenerator_C.ApplyMist"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function LevelGenerator.LevelGenerator_C.ExecuteUbergraph_LevelGenerator"));
