...
{
public:
	unsigned char                                      UnknownData_ZNMO[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class StartupInitializer.StartupInitializer"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_2XDX[0x138];                                   // 0x0070(0x0138) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class StartupInitializer.ClientStartupInitializer"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_NQTR[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UPPB[0x28];                                    // 0x0080(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class StartupInitializer.DedicatedServerStartupInitializer"));
		return ptr;
	}
