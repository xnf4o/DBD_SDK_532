...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.DBDAIBTController.OnPawnBump"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.DBDAIBTController.Authority_FinishedPlaying"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.DBDAIStateComponent.OnUniqueGameplayEvent"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.DBDAIStateComponent.OnStartAimingEventDispatched"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.DBDAIStateComponent.OnSpecialAttackEventDispatched"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.DBDNavLinkCustomComponent.OnLevelReadyToPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.NavLinkProxy_Base.OnSmartLinkReachedCallback"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.NavLinkProxy_Base.AutoAdjustSmartLinkPoints"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DBDBots.NavLinkProxy_DirectMove.OnDisplayDebugInfo"));
