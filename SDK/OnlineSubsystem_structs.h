...
struct FNamedInterface
{
	...
	unsigned char                                      UnknownData_S16A[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       InterfaceName;                                             // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_EGYY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductInfo
{
	...
	unsigned char                                      UnknownData_2N9C[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest
{
	...
	unsigned char                                      UnknownData_SLXM[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
