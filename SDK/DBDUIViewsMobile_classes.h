...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.FriendsMenuUtilities"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.MatchConfigDifficultyDataAsset"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.MatchConfigOptionsDataAsset"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.MatchConfigTabsDataAsset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_KN5Z[0x10];                                    // 0x0260(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PR5G[0x78];                                    // 0x0288(0x0078) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.MobileBaseUserWidget"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_5WFB[0x8];                                     // 0x0310(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGAtlantaCustomMatchLobbyRule"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_EJG6[0x18];                                    // 0x0320(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGAtlantaCustomMatchLobbyScreen"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_61CC[0x4];                                     // 0x031C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AHBY[0x4];                                     // 0x037C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0W1I[0xA0];                                    // 0x0390(0x00A0) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGPageScrollWidget"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_Z1J6[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGGridPageScrollWidget"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_KRAZ[0xA0];                                    // 0x04F8(0x00A0) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGAtlantaMatchConfigPageScroll"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_68OL[0x8];                                     // 0x0428(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGBaseButtonWidget"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_7GHN[0x20];                                    // 0x0450(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGAtlantaMatchConfigPageScrollItem"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_2T09[0x70];                                    // 0x0468(0x0070) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGAtlantaMatchConfigScreen"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_EGGP[0x18];                                    // 0x0448(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGAtlantaMatchConfigTab"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_X8DG[0x8];                                     // 0x0438(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGAtlantaRequestRoleButton"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_AS2R[0x18];                                    // 0x0300(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZD0Z[0x10];                                    // 0x0340(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGBaseFriendListContextualMenuWidget"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ZVT7[0x20];                                    // 0x03A0(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGBaseFriendListElement"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_0NBE[0x18];                                    // 0x0430(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FAN8[0x7];                                     // 0x0469(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       TitleOfTab;                                                // 0x0470(0x0018) (Edit, DisableEditOnTemplate, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_86QK[0x8];                                     // 0x0488(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGBaseTabButtonWidget"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGBaseTabListWidget"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_N930[0x6];                                     // 0x0302(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EKJB[0x8];                                     // 0x0348(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_08DP[0x40];                                    // 0x0360(0x0040) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGExpandableListWidget"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGFriendBaseTabListWidget"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_LVGV[0x7];                                     // 0x0451(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGFriendButtonWidget"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGFriendContextualMenuWidget"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGFriendElementWidget"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGFriendListTabWidget"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGFriendPartyListElementWidget"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_Y0V4[0x30];                                    // 0x0300(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGFriendSearchBarWidget"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_LX43[0x50];                                    // 0x04A0(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGFriendTabButtonWidget"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGRequestsListTabWidget"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_CQGX[0x4];                                     // 0x0314(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGScrollListPageButton"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class DBDUIViewsMobile.UMGSuggestionsListTabWidget"));
		return ptr;
	}
