...
public:
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class MagicLeapController.MagicLeapControllerFunctionLibrary"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_59E7[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I1ME[0x58];                                    // 0x00F0(0x0058) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class MagicLeapController.MagicLeapTouchpadGesturesComponent"));
		return ptr;
	}
