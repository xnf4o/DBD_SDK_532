...
public:
	...
	unsigned char                                      UnknownData_AYE9[0x8];                                     // 0x0248(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioUtilities.SplineAudioEmitterActor"));
		return ptr;
	}
