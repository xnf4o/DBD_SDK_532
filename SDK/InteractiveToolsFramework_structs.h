...
{
	unsigned char                                      UnknownData_F7JU[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
struct FBehaviorInfo
{
	...
	unsigned char                                      UnknownData_XDRZ[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FActiveGizmo
{
	unsigned char                                      UnknownData_NB59[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FInputRayHit
{
	unsigned char                                      UnknownData_GPCM[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
