...
struct FModifierReplicatedEventConditionData
{
	...
	unsigned char                                      UnknownData_3ZWM[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9D1Z[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V0AZ[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
